...
#pragma omp parallel for
	...
	conj(ct_evalmod[1], ckey2, ct_conj_2);

	ct_evalmod[0] += ct_conj_2;
	...
	R_Q<LOGQ_after_evalmod, N> pt_out;
	HEAAN<LOGQ_after_evalmod, N>::dec(ct_evalmod[0], s, pt_out);
	decode_log(pt_out, LOGDELTA, z_out);
	print_max_error<LOGN>(z, z_out);
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOGDELTA_ori>
void plain_test_S2C_first_adaptive()
{
	std::cout << "Measuring error on plain_S2C_first adap" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
#pragma omp section
		{
			...
			CoeffToSlot_adaptive<LOGQ, LOGN, LOGDELTA_cts, G>(ct_modraise, s, ct_cts);
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOGDELTA_ori>
void plain_test_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on plain_S2C_first adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
	...
	SlotToCoeff_adaptive<LOGq_up, LOGN, LOGDELTA_stc, G_S>(ct_1, ct_2, s, ct_stc);
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void plain_12_S2C_first_adaptive()
{
	std::cout << "Measuring error on plain_S2C_first_12 adap" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
#pragma omp section
		{
			...
			CoeffToSlot_sw_adaptive<LogQ_new_rs, LOGN, LOGDELTA_cts, G>(ct_RS, s, ct_cts);
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void plain_12_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on plain_S2C_first_12 adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void plain_all_together_bootstrap_test_S2C_first()
{
	std::cout << "Measuring error on all together bootstrap w erpluspar_S2C_first" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void plain_all_together_bootstrap_test_S2C_first_adaptive()
{
	std::cout << "Measuring error on all together bootstrap w plain all adap" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void plain_all_together_bootstrap_test_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on all together bootstrap w plain all adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
#pragma omp section
	...
	tuple_SlotToCoeff_adaptive<LOGq_up - LOG_qdiv, LOGN, LOGDELTA_stc, G_S, LOG_qdiv>(ct_par_res0_up, ct_par_res0_down, ct_par_res1_up, ct_par_res1_down, s, ct_stc_up, ct_stc_down);
	recomb< LOGq_up - LOG_qdiv, N, LOG_qdiv>(ct_stc_up, ct_stc_down, ct_stc);
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void plain_23_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on plain 23 adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
#pragma omp section
		{
			...
			CoeffToSlot_adaptive<LogQ_new_rs, LOGN, LOGDELTA_cts, G>(ct_RS, s, ct_cts);
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void erpluspar_all_together_bootstrap_test_S2C_first_adaptive()
{
	std::cout << "Measuring error on all together bootstrap w erpluspar_S2C_first_adap" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void erpluspar_12_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on erpluspar_S2C_first_12_adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOGDELTA_ori>
void evalroundplus_test_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on evalroundplus_S2C_first_adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void erpluspar_23_S2C_first_adaptive()
{
	std::cout << "Measuring error on all together bootstrap w erpluspar_S2C_first_adap" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void erpluspar_23_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on 23 bootstrap w erpluspar_S2C_first_adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
...
template<int LOGN, int LOGDELTA_cts, int LOGDELTA_stc, int G, int G_S, int LOG_qdiv, int LOG_ql, int LogDelS, int LOGDELTA_ori>
void erpluspar_all_together_bootstrap_test_S2C_first_adaptive_S2C()
{
	std::cout << "Measuring error on all together bootstrap w erpluspar_S2C_first_adap_S2C" << std::endl;
	std::cout << "LOGN : " << LOGN << std::endl;
	std::cout << "LOGDELTA_cts : " << LOGDELTA_cts << std::endl;
	std::cout << "LOGDELTA_stc : " << LOGDELTA_stc << std::endl;
